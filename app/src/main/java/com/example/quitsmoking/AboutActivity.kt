...
class AboutActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val Link1: TextView? = findViewById(R.id.Paper_1)
        val Link2: TextView? = findViewById(R.id.Paper_2)
        val Link3: TextView? = findViewById(R.id.Paper_3)
        val Link4: TextView? = findViewById(R.id.Paper_4)
        val Link5: TextView? = findViewById(R.id.Paper_5)
        val Link6: TextView? = findViewById(R.id.Paper_6)
        if (Link1 != null) {
